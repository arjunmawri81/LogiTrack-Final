  ...
  return (
    <SuperAdminLayout>
      <div style={{ ...fontStyle, maxWidth: "1400px", margin: "0 auto", padding: "10px" }}>
        ...
        <div style={{ width: "300px", background: "linear-gradient(135deg, #065f46, #10b981)", borderRadius: "16px", padding: "24px", color: "#ffffff", marginBottom: "35px", boxShadow: "0 10px 25px -5px rgba(16, 185, 129, 0.15), 0 8px 10px -6px rgba(16, 185, 129, 0.15)" }}>
          <div style={{ fontSize: "12px", fontWeight: "600", textTransform: "uppercase", letterSpacing: "0.05em", color: "#a7f3d0", marginBottom: "12px" }}>
            Total Revenue
          </div>
              ...
              {invoices.length > 0 ? (
                invoices.map((invoice) => (
                  <tr key={invoice._id} style={{ background: "#ffffff" }}>
                    <td style={{ ...tdStyle, fontFamily: "monospace", color: "#475569", fontSize: "13px", letterSpacing: "0.03em" }}>
                      {invoice.invoiceNumber || invoice._id}
                    </td>

                    <td style={tdStyle}>
                      <span style={{ background: "#dcfce7", color: "#166534", padding: "6px 14px", borderRadius: "999px", fontWeight: "600", fontSize: "12px", display: "inline-block", letterSpacing: "0.02em" }}>
                ...
                <tr>
                  <td colSpan="3" style={{ textAlign: "center", padding: "48px 0", color: "#94a3b8", background: "#ffffff", fontSize: "14px", fontWeight: "500" }}>
